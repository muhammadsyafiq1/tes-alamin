...
@section('content')
    ...
    <body>
        ...
        <div class="container mt-4">
            <h2 class="text-center">Insert Dokumen Peserta</h2>
                ...
                <div class="modal-content">
                    ...
                    <form id="uploadForm" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="file_keterangan_sehat">Upload Surat Keterangan Sehat</label>
                                <input type="file" name="file_keterangan_sehat" id="file_keterangan_sehat"
        ...
        <script>
            $(document).ready(function() {
                ...
                var table = $('#pesertaTable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ url('list-peserta-data-diterima') }}",
                        type: "GET",
                        dataType: "json",
                    ...
                    $.ajax({
                        ...
                        error: function(xhr) {
                            ...
                            if (xhr.responseJSON && xhr.responseJSON.errors) {
                                ...
                                errorMsg += 'Gagal mengunggah dokumen.';
                            }
                            alert(errorMsg);
                        }
                    });
