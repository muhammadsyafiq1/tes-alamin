...
@section('content')
    ...
    <body>
        ...
        <div class="container mt-4">
            <h2 class="text-center">List Peserta Upload Dokumen</h2>
        ...
        <script>
            $(document).ready(function() {
                ...
                var table = $('#pesertaTable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ url('list-peserta-upload-dokumen') }}",
                        type: "GET",
                        dataType: "json",
                ...
                $('#formPeserta').submit(function(e) {
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            status_peserta: $('#status_peserta').val(),
                            status_dokumen: $('#status_dokumen').val()
                        },
                        dataType: 'json',
                ...
                $(document).on('click', '.edit', function() {
                    ...
                    $.get('/peserta/edit/' + id, function(data) {
                        ...
                        $('#status_peserta').val(data.status_peserta);
                        $('#status_dokumen').val(data.status_dokumen);
                        $('#modalPeserta').modal('show');
                    }).fail(function(xhr) {
