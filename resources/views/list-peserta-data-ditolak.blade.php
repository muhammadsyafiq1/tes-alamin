...
@section('content')
    ...
    <body>
        ...
        <div class="container mt-4">
            <h2 class="text-center">List Peserta Ditolak</h2>
        ...
        <script>
            $(document).ready(function() {
                ...
                var table = $('#pesertaTable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ url('list-peserta-data-ditolak') }}",
                        type: "GET",
                        dataType: "json",
                ...
                // Fungsi untuk menangani error AJAX dan redirect ke login jika session habis
