...
@section('content')
    ...
    <body>
        ...
        <div class="container mt-4">
            <h2 class="text-center">Insert Data Peserta</h2>

            <!-- Tombol Tambah Peserta -->
            <button class="btn btn-primary mb-3" id="btn-add">Tambah Peserta</button>
